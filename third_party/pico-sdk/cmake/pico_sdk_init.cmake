...
get_filename_component(PICO_SDK_MOCK_ROOT "${CMAKE_CURRENT_LIST_DIR}/.." ABSOLUTE)

function(pico_sdk_init)
  if (NOT TARGET pico_stdlib)
    add_subdirectory(${PICO_SDK_MOCK_ROOT}/src ${CMAKE_BINARY_DIR}/pico-sdk)
  endif()
  foreach(lib hardware_pio hardware_dma hardware_irq pico_multicore tinyusb_device tinyusb_board)
    if (NOT TARGET ${lib})
